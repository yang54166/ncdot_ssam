...
export default function ServiceOrderListFilterResults(context) {
    let result1 = context.evaluateTargetPath('#Page:ServiceOrderFilterPage/#Control:SortFilter/#Value');
    let result2 = context.evaluateTargetPath('#Page:ServiceOrderFilterPage/#Control:MobileStatusFilter/#Value');
    let result3 = context.evaluateTargetPath('#Page:ServiceOrderFilterPage/#Control:PriorityFilter/#Value');
