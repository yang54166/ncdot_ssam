...
export default function TimeSheetDetailsNavWrapper(context) {
    ...
    libCrew.initializeCrewHeader(context).then( function() { //Initialize today's crew
        ...
        return pageProxy.executeAction('/SAPAssetManager/Actions/Crew/TimeSheets/TimeSheetDetailsNav.action');
    });
