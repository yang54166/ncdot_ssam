...
export default function VehiclesListViewNavWrapper(context) {
    ...
    libCrew.initializeCrewHeader(context).then( function() { //Initialize today's crew
        ...
        return pageProxy.executeAction('/SAPAssetManager/Actions/Crew/Vehicle/VehiclesListViewNav.action');
    });
