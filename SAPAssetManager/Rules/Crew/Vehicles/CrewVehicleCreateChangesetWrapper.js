...
export default function CrewVehicleCreateChangesetWrapper(context) {
    ...
    libCrew.initializeCrewHeader(context).then( function() { //Initialize today's crew
        ...
        return pageProxy.executeAction('/SAPAssetManager/Actions/Crew/CrewVehicleCreateChangeset.action');
    });
