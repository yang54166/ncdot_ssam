    ...
    static getEntityConfig() {
        return {
            'MyWorkOrderHeaders': {
                ...
                'createAction': DeepLinkLibrary.Z_WorkOrderCreateFromNotificationNav,  // hlf - NCDOT only create work order from noti
                'createActionFromNoti': DeepLinkLibrary.CreateWorkOrderNav,             // hlf - for now keep the switch for tracing
